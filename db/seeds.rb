...
user4 = User.create!(first_name: "Jade",last_name: "Grimm", nickname:"JadeJadou", address:"Lausanne", kids_average_age:"6", kids_count:"1", email: "jade@jadeajadou.com", password: "123456", avatar:"AV_sloth_black.png", description: "Hello! Super app! Hâte de vous rencontrer au parc les Buddies!! :) .")
#Geneve
user5 = User.create!(first_name: "Julie",last_name: "Desbois", nickname:"JusdeFruits", address:"Geneve", kids_average_age:"3", kids_count:"3", email: "user5@email.com", password: "azerty5", avatar:"AV_frog_black_green.png", description: "Je m’appelle JusdeFruits, et je chéris les moments passés au parc avec mes deux enfants. C’est toujours une aventure, mais parfois, je souhaite qu’il y ait plus d’opportunités pour moi de rencontrer et de se lier d’amitié avec d’autres parents.")
...
user7 = User.create!(first_name: "Pierre",last_name: "Lefevre", nickname:"PierrePaulJacques", address:"Geneve", kids_average_age:"6", kids_count:"1", email: "user7@email.com", password: "azerty7", avatar:"AV_pinguin_black.png", description: "J'aimerais apprécier le temps passé au parc autant que mes enfants.")
#Montreux

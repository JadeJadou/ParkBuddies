...
user4 = User.create!(first_name: "Jade",last_name: "Grimm", nickname:"Paul-Nord", address:"Lausanne", kids_average_age:"6", kids_count:"1", email: "jade@jadeajadou.com", password: "123456", avatar:"AV_sloth_black.png", description: "Hello! Super app! Hâte de vous rencontrer au parc les Buddies!! :) .")
#Geneve
